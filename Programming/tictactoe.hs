...
getNat prompt = do putStr prompt
                   ...
                   if xs /= [] && all isDigit xs then
                      ...
                      do putStr "Doe nou niet zo raar joh"
                         getNat prompt
...
main :: IO ()
main = do hSetBuffering stdout NoBuffering -- disable buffering
          play empty O
...
play' g p | wins O g = putStrLn "Player O wins\n"
          ...
          | p == X   = do putStr "Player X is thinking..."
                          (play $! (bestmove g p)) (next p) -- $! forces eager evaluation
